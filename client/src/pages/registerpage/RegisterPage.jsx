        ...
        <Container className="vh-100 d-flex align-items-center justify-content-center">
            <Row className="d-flex justify-content-center text-center auth-group">
                <div>
                    ...
                    {regErr? <p className="text-danger">Email already exists.</p> : null}
                </div>
                <Col md={10}>
                    {passErr? <span className="text-danger">Password does not match.</span> : null}
                    <Form onSubmit={handleSubmit} className="text-center">
                        <div className="form-group">
                            <input ref={firstRef} className="form-input" type="text" placeholder="First Name" required/>
                        </div>
                        <div className="form-group">
                            <input ref={lastRef} className="form-input" type="text" placeholder="Last Name" required/>
                        </div>
                        <div className="form-group">
                        ...
                        <div className="form-group">
                            <input ref={confirmPassRef} className="form-input" type="password" placeholder="Confirm Password" required/>
                        </div>
                        <div className="form-group">
