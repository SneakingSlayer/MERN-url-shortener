    ...
    <Navbar className="hp-navbar" collapseOnSelect expand="lg"  variant="light">
      ...
      <Navbar.Collapse id="responsive-navbar-nav">
        <Nav className="ms-auto d-flex align-items-center">
          <Nav.Link>
            <Link activeClass='active' to="hero" spy={true} smooth={true}>Home</Link>
          </Nav.Link>
          <Nav.Link>
            <Link activeClass='active' to="about" spy={true} smooth={true}>About</Link>
          </Nav.Link>
          <Nav.Link>
            <Link activeClass='active' to="shorten" spy={true} smooth={true}>Shorten</Link>
          </Nav.Link>
          <Nav.Link>
            <Link activeClass='active' to="faq" spy={true} smooth={true}>FAQ</Link>
          </Nav.Link>
          <Nav.Link className="ms-4" href="#login">
            <a href="/login" className="navbar-cta">Sign In</a>
          </Nav.Link>
        </Nav>
      </Navbar.Collapse>
      </Container>
